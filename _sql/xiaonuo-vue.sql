...
CREATE TABLE `flw_button` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354458710733524995 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程节点按钮表';
...
CREATE TABLE `flw_category` (
  ...
  `update_user` bigint(20) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354458450737008642 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程分类表';
...
CREATE TABLE `flw_draft` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354463315219484675 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='申请草稿表';
...
CREATE TABLE `flw_form` (
  ...
  `update_user` bigint(20) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354468741201842178 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程表单配置表';
...
CREATE TABLE `flw_form_resource` (
  ...
  `type` tinyint(4) DEFAULT '2' COMMENT '表单类型（字典 1自行开发 2在线设计）',
  `category` varchar(100) NOT NULL COMMENT '表单分类',
  `form_json` text COMMENT 'PC端表单数据，适用于在线设计表单',
  `form_url` varchar(100) DEFAULT NULL COMMENT 'PC端表单URL。适用于自行开发的表单',
  `app_form_url` varchar(100) DEFAULT NULL COMMENT '移动端表单URL',
  `remark` varchar(255) DEFAULT NULL COMMENT '描述',
  ...
  `update_user` bigint(20) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354468627381014531 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程脚本表';
...
CREATE TABLE `flw_option` (
  ...
  `update_user` bigint(20) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354458538599288834 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程选项配置表';
...
CREATE TABLE `flw_shortcut` (
  ...
  `update_user` bigint(20) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1354458994553688066 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程申请入口表';
