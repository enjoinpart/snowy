/*
 ...
 Source Catalog        : snowy-postgresql
...
CREATE TABLE "public"."flw_button" (
  ...
  "submit_btn" char(1) COLLATE "pg_catalog"."default",
  "save_btn" char(1) COLLATE "pg_catalog"."default",
  "back_btn" char(1) COLLATE "pg_catalog"."default",
  "turn_btn" char(1) COLLATE "pg_catalog"."default",
  "next_btn" char(1) COLLATE "pg_catalog"."default",
  "entrust_btn" char(1) COLLATE "pg_catalog"."default",
  "end_btn" char(1) COLLATE "pg_catalog"."default",
  "trace_btn" char(1) COLLATE "pg_catalog"."default",
  "suspend_btn" char(1) COLLATE "pg_catalog"."default",
  "jump_btn" char(1) COLLATE "pg_catalog"."default",
  "add_sign_btn" char(1) COLLATE "pg_catalog"."default",
  "delete_sign_btn" char(1) COLLATE "pg_catalog"."default",
...
COMMENT ON COLUMN "public"."flw_button"."submit_btn" IS '提交（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."save_btn" IS '保存（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."back_btn" IS '退回（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."turn_btn" IS '转办（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."next_btn" IS '指定（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."entrust_btn" IS '委托（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."end_btn" IS '终止（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."trace_btn" IS '追踪（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."suspend_btn" IS '挂起（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."jump_btn" IS '跳转（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."add_sign_btn" IS '加签（Y-是，N-否）';
COMMENT ON COLUMN "public"."flw_button"."delete_sign_btn" IS '减签（Y-是，N-否）';
...
INSERT INTO "public"."flw_script" VALUES (1345925988436881410, '获取表单数据', 1, 1, 'import vip.xiaonuo.flowable.core.utils.BpmScriptUtil;
